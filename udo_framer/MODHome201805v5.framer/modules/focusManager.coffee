...
addBorder = (layer) ->
	if (layer.childrenWithName("border").length is 0)
		...
		border = new Layer
			...
			opacity: 1
		if (layer.selectionBorderRadius is undefined)
...
try Layer.define "selectionBorderRadius",
	get: -> @_properties["selectionBorderRadius"]
	set: (value) ->
		@_properties["selectionBorderRadius"] = value
...
for existingLayer in layers
	...
	existingLayer.selectionBorderRadius = undefined
...
Framer.CurrentContext.on "layer:create", (newLayer) ->
	...
	newLayer.selectionBorderRadius = undefined
...
class focusManager extends Layer
	...
	@define 'defaultSelectionBorderRadius',
		get: ->
			return @.options.defaultSelectionBorderRadius
		set: (value)->
			defaultSelectionBorderRadius = @.options.defaultSelectionBorderRadius = value
